...
export default function Top1(){
  return <div className="flex-1 bg-gray-800 w-full flex-1 h-full bg-center" style={{backgroundImage: "url('your-image-url');"}}>
  ...
  <img src="./src/assets/icon-fonts/head.svg" alt="" className='pos-relative z-1' />
  <div className="flex flex-1 px-1 pt-14 pb-1 bg-gray-800">


    <div className="flex flex-col mx-auto max-w-2xl pt-8">
